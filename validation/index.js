...
const emailUserValidator = (req, res, next) => {
  return new Promise(async (resolve, reject) => {
    ...
    if (result) {
      return ResponseData.error(res, "This email already exists. Kindly Login or click on Forget Password to access your account.");
    } else {
      next();
    }
  });
...
const mobileUserValidator = (req, res, next) => {
  return new Promise(async (resolve, reject) => {
    ...
    if (result) {
      return ResponseData.error(res, "Mobile number already in use.");
    } else {
      next();
    }
  });
